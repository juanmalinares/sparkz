...
const SURPRISED_PIKACHU_URL = 'https://imgur.com/9VoOjHR';
const ANIMATION_TYPES = ['bounceIn', 'spin', 'pulse'];

const IncorrectPikachuAnimation = () => {
    ...
    >
      {pikachus.map((pika) => (
        <div key={pika.id} className={cn('pikachu-instance', pika.className)} style={pika.style}>
            <Image 
                src={fixImgurUrl(SURPRISED_PIKACHU_URL)} 
...
export default IncorrectPikachuAnimation;
